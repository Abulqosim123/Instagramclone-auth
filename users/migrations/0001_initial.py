    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_rules', models.CharField(choices=[('ordinary_user', 'ordinary_user'), ('manager', 'manager'), ('admin', 'admin')], default='ordinary_user', max_length=31)),
                ('AUTH_TYPE', models.CharField(choices=[('via_phone', 'via_phone'), ('via_email', 'via_email')], max_length=32)),
